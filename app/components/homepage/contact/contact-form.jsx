...
function ContactForm() {
  ...
  return (
    <div>
      <p className="font-medium mb-5 text-[#046a38] text-xl uppercase text-3xl font-bold leading-10 text-white md:font-extrabold">Contact me</p>
      <div className="max-w-3xl text-black bg-[#2F2F2F] rounded-lg border border-[#464c6a] p-3 lg:p-5">
        ...
        <div className="mt-6 flex flex-col gap-4">
          ...
          <div className="flex flex-col items-center gap-3">
            ...
            <button
              className="flex items-center gap-1 hover:gap-3 rounded-full bg-blue-700 px-5 md:px-12 py-2.5 md:py-3 text-center text-xs md:text-sm font-medium uppercase tracking-wider text-white no-underline transition-all duration-200 ease-out hover:text-white hover:no-underline md:font-semibold"
              role="button"
